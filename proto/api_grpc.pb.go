...
func (c *goCaptchaServiceClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*GetDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoCaptchaService_GetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCaptchaServiceClient) CheckData(ctx context.Context, in *CheckDataRequest, opts ...grpc.CallOption) (*CheckDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoCaptchaService_CheckData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCaptchaServiceClient) CheckStatus(ctx context.Context, in *StatusInfoRequest, opts ...grpc.CallOption) (*StatusInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoCaptchaService_CheckStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCaptchaServiceClient) GetStatusInfo(ctx context.Context, in *StatusInfoRequest, opts ...grpc.CallOption) (*StatusInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusInfoResponse)
	err := c.cc.Invoke(ctx, GoCaptchaService_GetStatusInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goCaptchaServiceClient) DelStatusInfo(ctx context.Context, in *StatusInfoRequest, opts ...grpc.CallOption) (*StatusInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusInfoResponse)
	err := c.cc.Invoke(ctx, GoCaptchaService_DelStatusInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGoCaptchaServiceServer must be embedded to have
...
func (UnimplementedGoCaptchaServiceServer) testEmbeddedByValue()                          {}
...
func RegisterGoCaptchaServiceServer(s grpc.ServiceRegistrar, srv GoCaptchaServiceServer) {
	// If the following call pancis, it indicates UnimplementedGoCaptchaServiceServer was
